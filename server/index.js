...
import beaireadyLeadfinderRoutes from './routes/beaiready-leadfinder.js';
...
app.use('/api/beaiready/leadfinder', requireAuth, resolveTenant, beaireadyLeadfinderRoutes);
