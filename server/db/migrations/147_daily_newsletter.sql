...
CREATE TABLE IF NOT EXISTS newsletter_issues (
  ...
  -- The editable NEWS body (markdown, sections only — no subject, no promo
  -- block). Seeded from the generated issue; Paul sharpens it in the review
  -- desk and this is what "Copy for Substack" and the corpus save use.
